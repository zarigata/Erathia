...
# Height variation per biome (how much terrain can vary within biome)
var _biome_variation: Dictionary = {
	MapGenerator.Biome.PLAINS: 8.0,
	MapGenerator.Biome.FOREST: 15.0,
	MapGenerator.Biome.DESERT: 10.0,
	MapGenerator.Biome.SWAMP: 4.0,
	MapGenerator.Biome.TUNDRA: 20.0,
	MapGenerator.Biome.JUNGLE: 12.0,
	MapGenerator.Biome.SAVANNA: 6.0,
	MapGenerator.Biome.MOUNTAIN: 60.0,
	MapGenerator.Biome.BEACH: 2.0,
	MapGenerator.Biome.DEEP_OCEAN: 15.0,
	MapGenerator.Biome.ICE_SPIRES: 80.0,
	MapGenerator.Biome.VOLCANIC: 50.0,
	MapGenerator.Biome.MUSHROOM: 20.0,
	# Transition biomes have moderate variation
	MapGenerator.Biome.SLOPE_PLAINS: 5.0,
	MapGenerator.Biome.SLOPE_FOREST: 8.0,
	MapGenerator.Biome.SLOPE_MOUNTAIN: 15.0,
	MapGenerator.Biome.SLOPE_SNOW: 20.0,
	MapGenerator.Biome.SLOPE_VOLCANIC: 12.0,
	MapGenerator.Biome.CLIFF_COASTAL: 3.0,
	MapGenerator.Biome.SLOPE_DESERT: 6.0,
}
...
func _initialize_noise() -> void:
	...
	_terrain_noise.frequency = 0.004
	...
	_mountain_noise.frequency = 0.001
